          ...
          <Card className="p-6 card-shadow">
            ...
            <div className="space-y-4">
              {[
                {
                  type: "match",
                  text: "New match with Sarah Chen from TechVentures Capital",
                  time: "2 hours ago",
                  icon: Heart
                },
                {
                  type: "message",
                  text: "Message received from Marcus Rodriguez",
                  time: "1 day ago", 
                  icon: MessageCircle
                },
                {
                  type: "view",
                  text: "Your listing was viewed 23 times today",
                  time: "1 day ago",
                  icon: TrendingUp
                }
              ].map((activity, index) => (
...
const SellerDashboard = () => {
  ...
  const userType = 'seller' as const
      ...
      if (token) {
        fetch(`${base}/auth/me`, {
          ...
          .then((data) => {
            ...
            if (name && typeof name === 'string' && name.trim()) setUsername(name);
          })
          .catch(() => {});
      }
    } catch {
