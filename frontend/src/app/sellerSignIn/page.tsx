...
const SellerSignIn = () => {
  ...
  const onSubmit = async (data: SignInFormData) => {
    try {
      console.log("Seller sign-in data:", data);
      ...
      if (result.data.role !== 'seller') {
        alert('Invalid user type. Please use the buyer sign-in instead.');
        return;
      }
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Sign in to your seller account and continue your journey
          </CardDescription>
        </CardHeader>
